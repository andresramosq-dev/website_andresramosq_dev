export const site = {
	...
	role: 'Desarrollador de Software especializado en desarrollo Backend',
	...
	description:
		'Consola personal de Andrés Ramos. Desarrollo de software backend, interfaces y notas sobre el oficio.',
